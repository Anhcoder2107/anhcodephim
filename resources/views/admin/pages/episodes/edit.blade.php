    ...
    <div class="content-row">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form novalidate="" role="form" class="form-horizontal" method="POST" action="{{ route('admin.episodes.update', $id) }}">
                    @csrf
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            ...
                            value="{{ $episode->movie->name }}" disabled>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            ...
                            name="link">{{ $episode->link }}</textarea>
                        </div>
                    </div>
                    <div class="form-group">

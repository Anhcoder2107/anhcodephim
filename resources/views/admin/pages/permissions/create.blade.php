...
@section('container')
    ...
    <div class="content-row">
        <div class="panel panel-default">
            <div class="panel-heading">
                <div class="panel-title"><b>Create Permission </b>
                </div>
            ...
            <div class="panel-body">
                ...
                @endif
                <form novalidate="" role="form" class="form-horizontal" method="POST" action="{{ route('admin.permissions.store') }}">
                    @csrf
    ...
    @endcan
    @cannot('Create permission', Auth::user())
        <div class="alert alert-danger">
            <strong>Sorry!</strong> You don't have permission to create permission.
        </div>
    @endcannot
@endsection
